...
monster.loot = {
	{name = "Crystal Coin", chance = 24890, minCount = 1, maxCount = 3},
	...
	{name = "Gold Ingot", chance = 120, maxCount = 40},
	{name = "Primal Bag", chance = 1}
}

monster.attacks = {
	{name ="melee", interval = 600, chance = 100, minDamage = -300, maxDamage = -801},
	{name ="combat", interval = 1000, chance = 47, type = COMBAT_PHYSICALDAMAGE, minDamage = -800, maxDamage = -2500, effect = CONST_ME_YELLOWSMOKE, target = true},
	{name ="combat", interval = 800, chance = 31, type = COMBAT_ENERGYDAMAGE, minDamage = -800, maxDamage = -2500, radius = 4, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="drunk", interval = 688, chance = 10, length = 3, spread = 2, effect = CONST_ME_ENERGYAREA, target = false, duration = 5000},
}
