...
monster.loot = {
	{name = "Crystal Coin", chance = 28240, maxCount = 2},
	...
	{name = "Gold Ingot", chance = 230, maxCount = 18},
	{name = "Primal Bag", chance = 1}	
}

monster.attacks = {
	{name ="melee", interval = 600, chance = 100, minDamage = 0, maxDamage = -2455},
	{name ="combat", interval = 800, chance = 30, type = COMBAT_PHYSICALDAMAGE, minDamage = -300, maxDamage = -2400, range = 7, shootEffect = CONST_ANI_LARGEROCK, target = false}
}
