...
monster.health = 43650
monster.maxHealth = 43650
monster.race = "energy"
...
monster.loot = {
	{name = "Crystal Coin", chance = 23440, minCount = 1, maxCount = 5},
	...
	{name = "Violet Gem", chance = 1250, maxCount = 2},
	{name = "Gold Ring", chance = 600},
	{name = "Green Gem", chance = 420},
	{name = "Ring of the Sky", chance = 210},
	{name = "Gold Ingot", chance = 198, maxCount = 30},
	{name = "Primal Bag", chance = 1}
}

monster.attacks = {
	{name ="melee", interval = 500, chance = 100, minDamage = 300, maxDamage = -1801},
	{name ="combat", interval = 250, chance = 10, type = COMBAT_ENERGYDAMAGE, minDamage = -400, maxDamage = -1800, length = 7, spread = 0, effect = CONST_ME_PINK_ENERGY_SPARK, target = false},
	{name ="combat", interval = 800, chance = 45, type = COMBAT_PHYSICALDAMAGE, minDamage = -2037, maxDamage = -2650, length = 6, spread = 1, effect = CONST_ME_SOUND_PURPLE, target = false},
}
