...
monster.loot = {
	...
	{name = "Crystal Coin", chance = 22310, minCount = 1, maxCount = 3},
	...
	{name = "Gold Ingot", chance = 230, maxCount = 20}, 
	{name = "Primal Bag", chance = 1}
}

monster.attacks = {
	{name ="melee", interval = 400, chance = 100, minDamage = -300, maxDamage = -1801},
	{name ="combat", interval = 500, chance = 47, type = COMBAT_PHYSICALDAMAGE, minDamage = -800, maxDamage = -2500, range = 4, shootEffect = CONST_ANI_HOLY, effect = CONST_ME_YELLOW_RINGS, target = true},
	{name ="combat", interval = 300, chance = 31, type = COMBAT_LIFEDRAIN, minDamage = -800, maxDamage = -1900, radius = 4, effect = CONST_ME_YELLOWSMOKE, target = true},
}
