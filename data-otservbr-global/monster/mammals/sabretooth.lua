...
monster.loot = {
	...
	{name = "Crystal Coin", chance = 23350, minCount = 1, maxCount = 3},
	...
	{name = "Gold Ingot", chance = 255, maxCount = 19},
	{name = "Primal Bag", chance = 1}
}

monster.attacks = {
	{name ="melee", interval = 1000, chance = 100, minDamage = -300, maxDamage = -3450, effect = CONST_ME_ORANGE_ENERGY_SPARK},
	{name ="combat", interval = 500, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -260, maxDamage = -4300, length = 4, spread = 1, effect = CONST_ME_EXPLOSIONAREA, target = false},
}
