...
monster.loot = {
	{name = "Crystal Coin", chance = 34190, maxCount = 2},
	...
	{name = "Gold Ingot", chance = 210, maxCount = 17},
	{name = "Primal Bag", chance = 1}
}

monster.attacks = {
	{name ="melee", interval = 700, chance = 100, minDamage = 0, maxDamage = -1000},
	{name ="combat", interval = 600, chance = 15, type = COMBAT_ENERGYDAMAGE, minDamage = -300, maxDamage = -2450, length = 5, spread = 2, effect = CONST_ME_ENERGYAREA, target = false},
	{name ="combat", interval = 500, chance = 10, type = COMBAT_PHYSICALDAMAGE, minDamage = -260, maxDamage = -1450, range = 7, radius = 3, effect = CONST_ME_ENERGYAREA, target = true}
}
