...
monster.health = 45620
monster.maxHealth = 45620
monster.race = "blood"
...
monster.loot = {
	...
	{name = "Crystal Coin", chance = 30050, maxCount = 2},
	...
	{name = "Gold Ingot", chance = 220, maxCount = 22},
	{name = "Primal Bag", chance = 1}
}

monster.attacks = {
	{name ="melee", interval = 700, chance = 100, minDamage = -300, maxDamage = -2400},
	{name ="combat", interval = 500, chance = 15, type = COMBAT_PHYSICALDAMAGE, minDamage = -400, maxDamage = -2400, range = 7, shootEffect = CONST_ANI_SUDDENDEATH, target = true}
